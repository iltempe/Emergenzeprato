...
//In zona B5
$sir_str_1_2=("Rischio idrogeologico-idraulico Comuni di Vernio Cantagallo (B5): " .$sir_xml->rischi->rischio[0]->area[8]->impatto);
print_r($sir_str_1_2);

$sir_str_2_2=("Rischio vento Comuni di Vernio Cantagallo (B5): " .$sir_xml->rischi->rischio[1]->area[8]->impatto);
print_r($sir_str_2_2);

$sir_str_3_2=("Rischio mareggiate Comuni di Vernio Cantagallo (B5): " .$sir_xml->rischi->rischio[2]->area[8]->impatto);
print_r($sir_str_3_2);

$sir_str_4_2=("Rischio neve Comuni di Vernio Cantagallo (B5): " .$sir_xml->rischi->rischio[3]->area[8]->impatto);
print_r($sir_str_4_2);

$sir_str_5_2=("Rischio ghiaccio Comuni di Vernio Cantagallo (B5): " .$sir_xml->rischi->rischio[4]->area[8]->impatto);
print_r($sir_str_5_2);
